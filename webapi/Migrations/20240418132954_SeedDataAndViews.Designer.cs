...
namespace webapi.Migrations
{
    ...
    [Migration("20240418132954_SeedDataAndViews")]
    partial class SeedDataAndViews
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("webapi.Models.HR.Contract", b =>
                {
                    ...
                    b.Property<int>("AdministrativeTerritoryId")
                        .HasColumnType("integer")
                        .HasColumnName("administrative_territory_id");
                    ...
                    b.Property<int>("IconomicActivityId")
                        .HasColumnType("integer")
                        .HasColumnName("iconomic_activity_id");
                    ...
                    b.HasIndex("AdministrativeTerritoryId")
                        .HasDatabaseName("ix_contracts_administrative_territory_id");
                    ...
                    b.HasIndex("IconomicActivityId")
                        .HasDatabaseName("ix_contracts_iconomic_activity_id");

                    b.HasIndex("PositionId")
                        .HasDatabaseName("ix_contracts_position_id");
            ...
            modelBuilder.Entity("webapi.Models.HR.PersonalData", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_personal_datas");

                    b.HasIndex("AddressId")
                        .HasDatabaseName("ix_personal_datas_address_id");

                    b.ToTable("personal_datas", (string)null);
                });
            ...
            modelBuilder.Entity("webapi.Models.HR.Contract", b =>
                {
                    b.HasOne("webapi.Models.System.SysAdministrativeTerritory", "AdministrativeTerritory")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_contracts_sys_administrative_territories_administrative_ter");
                    ...
                    b.HasOne("webapi.Models.System.SysIconomicActivity", "IconomicActivity")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_contracts_sys_iconomic_activities_iconomic_activity_id");
                    ...
                    b.HasOne("webapi.Models.System.SysPosition", "Position")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_contracts_sys_positions_position_id");
            ...
            modelBuilder.Entity("webapi.Models.HR.Employee", b =>
                {
                    ...
                    b.HasOne("webapi.Models.HR.PersonalData", "PersonalData")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_employees_personal_datas_personal_data_id");
            ...
            modelBuilder.Entity("webapi.Models.HR.PersonalData", b =>
                {
                    b.HasOne("webapi.Models.HR.Address", "Address")
                        ...
                        .HasConstraintName("fk_personal_datas_addresses_address_id");
